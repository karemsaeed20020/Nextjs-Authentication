      ...
      <section className="py-20 px-6 bg-gray-50 text-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600">
            Kareem is a powerful platform built for modern web experiences. We help users connect and grow.
          </p>
        </div>
      </section>
      <section className="py-20 px-6 bg-white text-gray-800">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p>We use strong validation and secure flows like Zod + Redux Toolkit.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Modern UI</h3>
            <p>Built with Framer Motion, React Hook Form, and Tailwind CSS for a stunning interface.</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Responsive Design</h3>
            <p>Fully responsive layout that adapts to all screen sizes without performance issues.</p>
          </div>
        </div>
      </section> 
    </>
